...
class PasswordResetConfirmTests(TestCase):
    ...
    def setUp(self):
        user = User.objects.create_user(username='john', email='john@doe.com', password='1234adsc')
...
class InvalidPasswordResetConfirmTests(TestCase):
    ...
    def test_html(self):
        password_reset_url1 = reverse('password_reset')
        self.assertContains(self.response, 'invalid password reset link')
        self.assertContains(self.response, 'href="{0}"'.format(password_reset_url1))
