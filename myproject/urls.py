...
urlpatterns = [
    # path('', views.home, name='home'),   # 即对应url为 http://127.0.0.1:8000/     反解析用  '/'
    path('',views.BoardListView.as_view(), name='home'),
    path('home/home2/', views.home2, name='home2'),
    ...
    #
    path('boards/<pk>/topics/<topic_pk>/posts/<post_pk>/edit/', views.PostUpdateView.as_view(),
        name = 'edit_post'),
